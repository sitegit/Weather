...
import com.example.weather.presentation.utils.formattedFullDate
import com.example.weather.presentation.utils.formattedShortDayOfWeek
...
fun DetailsContent(
    ...
    StatusBarTextColor(isLight = false, decorFitsSystemWindow = false)
...
private fun Error() {
    ...
    Box(
        ...
        Text(
            ...
            text = stringResource(id = R.string.error_loaded_weather),
            textAlign = TextAlign.Center,
            color = MaterialTheme.colorScheme.background,
            fontSize = 32.sp,
            lineHeight = 50.sp
